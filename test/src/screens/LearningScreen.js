...
import { getFlashcards } from '../api'; // ⬅️ pobiera fiszki z backendu
...
const styles = StyleSheet.create({
  ...
  card: { width: 300, height: 200, marginBottom: 20 },
  face: {
    flex: 1,
    backgroundColor: '#fff',
    borderRadius: 15,
  ...
  cardText: { fontSize: 20, fontWeight: '600', color: '#000', textAlign: 'center' },
  actions: { flexDirection: 'row', marginTop: 30 },
  text: { fontSize: 18, fontWeight: '500', color: '#000' },
  resultText: { fontSize: 22, fontWeight: '700', marginBottom: 10, color: '#000' },
  percentage: { fontSize: 28, fontWeight: '800', marginBottom: 20, color: '#000' },
  button: {
    backgroundColor: '#000',
    paddingVertical: 10,
